...
/*    public List<Person> getPersons() {
    ...
    public List<Person> findPeople(String id, String name, String middlename, String surname, String dob, String sex){
        ...
        if (middlename != null && !middlename.isEmpty()) query_where.add("middle_name='"+middlename+"'");
        if (surname!= null&&!surname.isEmpty()) query_where.add("surname='"+surname+"'");
        if (dob!=null&&!dob.isEmpty()) query_where.add("dob='"+dob+"'");
        if (sex!= null &&!sex.isEmpty()) query_where.add("sex='"+sex+"'");
